...
function ErrorPage() {
  ...
  return (
    <div className='container'>
      ...
      <h2 className='sorry'>SilentCosmicSorry :(</h2>

<div><div className="error">
        <svg width="1123" height="837" viewBox="0 0 1023 637" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="1123" height="837" fill="#111"/>
            <g id="sky" filter="url(#filter0_d)">
            <rect id="background" x="0" y="0" width="1063" height="777" rx="20" fill="#111"/>
            <g id="stars">
